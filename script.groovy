...
def buildImage() {
    ...
    sh 'aws ecr get-login-password --region us-west-2 --profile iam-roles-anywhere | docker login --username AWS --password-stdin 851725525319.dkr.ecr.us-west-2.amazonaws.com'
